...
[_DEFAULT] = LAYOUT( \
    ...
    KC_LSFT,KC_QUOT,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_BSPC, \
 ...
 */
[_MOUSE] = LAYOUT( \
    _______,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX,KC_DEL,  \
...
[_LOWER] = LAYOUT( \
    ...
    _______,XXXXXXX,_______,_______,_______,         _______,       _______,NXTPRV, KC_VOLD,KC_VOLU,KC_MPLY  \
  ),
/* Raise Layer
 * ,-------------------------------------------------------------------------------------------------------.
 * |       |  F1   |  F2   |  F3   |  F4   |  F5   |  F6   |  F7   |  F8   |  F9   |  F10  |  F11  |  F12  |
...
[_RAISE] = LAYOUT( \
    ...
    _______,_______,_______,_______,_______,_______,_______,_______,KC_PSCR,KC_SLCK,KC_PAUS,KC_APP, _______, \
    _______,XXXXXXX,_______,_______,_______,         _______,       _______,KC_HOME,KC_PGDN,KC_PGUP,KC_END   \
  ),
/* Adjust Layer
 * ,-------------------------------------------------------------------------------------------------------.
 * | RESET |       |       |       |       |       |       |       |       |       |       |       |       |
