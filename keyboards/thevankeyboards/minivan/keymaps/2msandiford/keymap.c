 ...
 * |-----------------------------------------------------------------------------------------------------|
 * |  Trns   | PScr  | SLock | Pause | Trns  |  App  |  Ins  | Trns  | Trns  | Trns  | Trns  |   Trns    |
 * |-----------------------------------------------------------------------------------------------------|
...
[_L3] = LAYOUT_arrow(
    ...
    _______,  KC_PSCR,KC_SLCK,KC_PAUS,_______,KC_APP, KC_INS, _______,_______,_______,_______,_______,
